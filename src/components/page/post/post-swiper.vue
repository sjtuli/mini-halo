...
/**
 * swiper 轮播图
 * @see https://github.com/YanxinNet/uView/blob/master/uview-ui/components/u-swiper/u-swiper.vue
 * @license https://github.com/YanxinNet/uView/blob/master/LICENSE
...
export default {
  ...
  computed: {
    justifyContent() {
      ...
      if (
        this.indicatorPos == "topRight" ||
        this.indicatorPos == "bottomRight"
      ) {
        return "flex-end";
      }
      return "";

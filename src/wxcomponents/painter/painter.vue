<template>
<uni-shadow-root class="painter-painter"><view :style="'position: relative;'+(customStyle)+';'+(painterStyle)">
  <block v-if="(!use2D)">
    <canvas canvas-id="photo" :style="(photoStyle)+';position: absolute; left: -9999px; top: -9999rpx;'"></canvas>
  ...
  <block v-if="use2D">
    <canvas type="2d" id="photo" :style="(photoStyle)+';'"></canvas>
